...
class BluetoothTransmitter: NSObject, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    func peripheral(_ peripheral: CBPeripheral, didWriteValueFor characteristic: CBCharacteristic, error: Error?) {
        ...
        if let error = error {
            trace("in didWriteValueFor. Characteristic %{public}@, characteristic description %{public}@, error =  %{public}@", log: log, category: ConstantsLog.categoryBlueToothTransmitter, type: .error, String(describing: characteristic.uuid), String(characteristic.debugDescription), error.localizedDescription)
        } else {
            trace("in didWriteValueFor. Characteristic %{public}@, characteristic description %{public}@", log: log, category: ConstantsLog.categoryBlueToothTransmitter, type: .info, String(describing: characteristic.uuid), String(characteristic.debugDescription))
        }
    }
